...
Shader "GGJ/Standard"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 appendResult367 = (float2(5.0 , 5.0));
			float2 ScreenUVs217 = ( ( lerp(( (( ( ( computeScreenPos10 / (computeScreenPos10).w ) - ( computeScreenPos15 / (computeScreenPos15).w ) ) * distance( ( float4( _WorldSpaceCameraPos , 0.0 ) - transform26 ) , float4( 0,0,0,0 ) ) )).xy * appendResult56 ),( i.uv2_texcoord2 * lerpResult322 ),_LightmapUVs) + float2( 0,0 ) + floor( ( appendResult367 * _Time.y ) ) ) + float2( 0,0 ) );
...
/*ASEBEGIN
Version=16200
0;734.2858;1479;420;-699.8414;191.1111;2.298083;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-3723.342,48.05357;Float;False;Property;_AOAmount;AO Amount;6;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;329;-3776.393,-274.1387;Float;False;Property;_IgnoreShadow;Ignore Shadow;9;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;358;-674.3278,-1696.951;Float;False;Constant;_FrameSpeed;Frame Speed;12;0;Create;True;0;0;False;0;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;367;-476.5996,-1690.35;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;361;-511.275,-1588.965;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FloorOpNode;369;-172.4385,-1682.178;Float;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;363;-142.675,-1831.165;Float;False;3;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;121;2504.084,-926.1227;Float;True;Property;_SketchTex;SketchTex;7;0;Create;True;0;0;False;0;None;b6baa34644121d44eac4744cdb329248;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;40;1774.948,-369.7809;Float;False;Property;_TopColor;Top Color;0;0;Create;True;0;0;False;0;0.8949356,0,1,0;0.7254902,0.5938485,0.3921567,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;102;1745.453,-552.2416;Float;False;Property;_BottomColor;Bottom Color;2;0;Create;True;0;0;False;0;0.1703008,0.8396226,0.1726939,0;0.6509804,0.37196,0.2862744,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7EE7E07BA9D031A30C7C8DFDB76CFA98FEF50126