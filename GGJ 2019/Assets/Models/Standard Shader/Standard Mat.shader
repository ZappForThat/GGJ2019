...
Shader "GGJ/Standard"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_output_238_0 = ( ( temp_output_35_0 * appendResult56 ) + ( (-1.0 + (lerpResult226 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) * _NoiseAmount ) );
...
/*ASEBEGIN
Version=16200
0;708.0001;934;453;2586.836;2730.385;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;237;-637.8328,-2061.398;Float;False;Property;_NoiseAmount;Noise Amount;9;0;Create;True;0;0;False;0;0.01;0.009411766;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;97;-805.6227,-2830.832;Float;False;Property;_FresnelBalance;Fresnel Balance;4;0;Create;True;0;0;False;0;0;-0.1889878;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;36.71055,-776.9004;Float;False;Property;_TopColor;Top Color;2;0;Create;True;0;0;False;0;0.8949356,0,1,0;0.8820755,1,0.9988678,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;102;51.21591,-993.361;Float;False;Property;_BottomColor;Bottom Color;3;0;Create;True;0;0;False;0;0.1703008,0.8396226,0.1726939,0;0.3215685,0.7176471,0.6978628,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=15463B2A24368CEE66AF828BFE071082F9EB9AF9