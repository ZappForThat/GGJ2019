...
Shader "GGJ/Standard"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif
			float4 color274 = IsGammaSpace() ? float4(0.1215686,0.2666667,0.5686275,1) : float4(0.01370208,0.05780545,0.2831488,1);
			...
			float mulTime361 = _Time.y * 7.0;
			float temp_output_369_0 = floor( mulTime361 );
			float2 appendResult367 = (float2(10.0 , 10.0));
			...
			float2 panner370 = ( temp_output_369_0 * appendResult367 + lerp(( (( ( ( computeScreenPos10 / (computeScreenPos10).w ) - ( computeScreenPos15 / (computeScreenPos15).w ) ) * distance( ( float4( _WorldSpaceCameraPos , 0.0 ) - transform26 ) , float4( 0,0,0,0 ) ) )).xy * appendResult56 ),( i.uv2_texcoord2 * lerpResult322 ),_LightmapUVs));
			float2 ScreenUVs217 = panner370;
			...
			#endif //aselc
			c.rgb = ( lerpResult272 + ( temp_output_296_0 * ase_lightColor ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=16200
0;638.2858;1442;516;1357.013;1937.492;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-3723.342,48.05357;Float;False;Property;_AOAmount;AO Amount;6;0;Create;True;0;0;False;0;0;0.589;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;371;-827.0134,-1608.492;Float;False;Constant;_Float10;Float 10;12;0;Create;True;0;0;False;0;7;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;358;-754.3278,-1792.951;Float;False;Constant;_FrameSpeed;Frame Speed;12;0;Create;True;0;0;False;0;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;361;-659.275,-1591.965;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;319;-738.6786,-1992.356;Float;False;Property;_LightmapUVs;Lightmap UVs;8;0;Create;True;0;0;False;0;0;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FloorOpNode;369;-448.4385,-1581.178;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;367;-583.5996,-1783.35;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PowerNode;213;600.8646,-3547.515;Float;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;370;-356.0134,-1830.492;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;40;1774.948,-369.7809;Float;False;Property;_TopColor;Top Color;0;0;Create;True;0;0;False;0;0.8949356,0,1,0;0.6784314,0.4419098,0.3568627,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;102;1745.453,-552.2416;Float;False;Property;_BottomColor;Bottom Color;2;0;Create;True;0;0;False;0;0.1703008,0.8396226,0.1726939,0;0.6784314,0.4419098,0.3568627,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LightColorNode;314;2572.163,278.2625;Float;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;315;2728.169,191.4581;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;68;297.1366,-3191.694;Float;False;F_Balance and Falloff;-1;;2;db63d5e8967e8734489214297d7545f6;0;3;1;FLOAT;0;False;3;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;368;-308.5996,-1676.35;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;363;-13.675,-1888.165;Float;False;3;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
WireConnection;367;1;358;0
WireConnection;213;0;212;0
WireConnection;213;1;214;0
WireConnection;370;0;319;0
WireConnection;370;2;367;0
WireConnection;370;1;369;0
WireConnection;217;0;370;0
