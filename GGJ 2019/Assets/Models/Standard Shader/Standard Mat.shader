...
Shader "GGJ/Standard"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 panner370 = ( floor( mulTime361 ) * appendResult367 + lerp(( (( ( ( computeScreenPos10 / (computeScreenPos10).w ) - ( computeScreenPos15 / (computeScreenPos15).w ) ) * distance( ( float4( _WorldSpaceCameraPos , 0.0 ) - transform26 ) , float4( 0,0,0,0 ) ) )).xy * appendResult56 ),( i.uv2_texcoord2 * lerpResult322 ),_LightmapUVs));
...
/*ASEBEGIN
Version=16200
0;880.5715;1525;274;1386.386;1875.717;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;371;-880.9241,-1674.576;Float;False;Constant;_Float10;Float 10;12;0;Create;True;0;0;False;0;6;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;361;-713.1857,-1658.049;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FloorOpNode;369;-502.3491,-1647.262;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=4F76E1D34BEC2CD9029E3EFD9129F0D6DB1CDE42