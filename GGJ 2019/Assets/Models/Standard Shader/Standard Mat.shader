...
Shader "GGJ/Standard"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float mulTime361 = _Time.y * 6.0;
			float2 appendResult367 = (float2(1.0 , 1.0));
			...
			float2 panner370 = ( (-3.0 + (floor( mulTime361 ) - 0.0) * (3.0 - -3.0) / (1.0 - 0.0)) * appendResult367 + lerp(( (( ( ( computeScreenPos10 / (computeScreenPos10).w ) - ( computeScreenPos15 / (computeScreenPos15).w ) ) * distance( ( float4( _WorldSpaceCameraPos , 0.0 ) - transform26 ) , float4( 0,0,0,0 ) ) )).xy * appendResult56 ),( i.uv2_texcoord2 * lerpResult322 ),_LightmapUVs));
...
/*ASEBEGIN
Version=16200
0;880.5715;1525;274;1591.37;2082.572;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;371;-1077.924,-1664.576;Float;False;Constant;_Float10;Float 10;12;0;Create;True;0;0;False;0;6;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;361;-905.1857,-1664.049;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FloorOpNode;376;-732.386,-1569.717;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;358;-754.3278,-1792.951;Float;False;Constant;_FrameSpeed;Frame Speed;12;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;373;-370.386,-1677.717;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-3;False;4;FLOAT;3;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=7DF8722CD521FC5593A899D95F5B005E43CEAB68