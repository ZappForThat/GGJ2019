...
Shader "New Amplify Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_output_233_0 = ( temp_output_35_0 * 1.5 );
			float lerpResult226 = lerp( tex2D( _Texture0, ( temp_output_233_0 + float2( 0.6,0.6 ) ) ).r , tex2D( _Texture0, temp_output_233_0 ).r , round( (0.0 + (sin( ( _Time.y * 24.0 ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) ));
			float2 temp_output_238_0 = ( ( temp_output_35_0 * appendResult56 ) + ( (-1.0 + (lerpResult226 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) * 0.009411766 ) );
			...
			float clampResult212 = clamp( ( (0.0 + (dotResult105 - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) + 0.05 ) , 0.0 , 1.0 );
			float clampResult216 = clamp( pow( clampResult212 , exp2( 0.3 ) ) , 0.0 , 1.0 );
			...
			float4 lerpResult72 = lerp( ( lerpResult101 * clampResult147 ) , color73 , Fresnel69);
...
/*ASEBEGIN
Version=16200
560;691.4286;909;457;3212.74;3245.953;8.201854;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;224;-2203.491,-2593.041;Float;False;Constant;_Float11;Float 11;9;0;Create;True;0;0;False;0;24;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;234;-1638.413,-2001.819;Float;False;Constant;_NoiseScale;Noise Scale;9;0;Create;True;0;0;False;0;1.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;228;-1812.515,-2349.303;Float;True;Property;_Texture0;Texture 0;8;0;Create;True;0;0;False;0;None;11bfd352aa2789f4ea8ed90fb8c05a3e;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-1524.595,-1504.008;Float;False;Property;_TexScale;Tex Scale;0;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;211;57.86459,-3469.515;Float;False;Constant;_Float8;Float 8;8;0;Create;True;0;0;False;0;0.05;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;237;-637.8328,-2061.398;Float;False;Constant;_NoiseAmount;Noise Amount;8;0;Create;True;0;0;False;0;0.009411766;0.0079;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;215;291.8646,-3396.515;Float;False;Constant;_Float10;Float 10;8;0;Create;True;0;0;False;0;0.3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;213;600.8646,-3547.515;Float;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;216;764.8646,-3520.515;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;129;-2767.776,-295.0136;Float;False;113;ShadowDot;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;193;-1400.344,143.6112;Float;True;Property;_TextureSample1;Texture Sample 1;1;0;Create;True;0;0;False;0;None;35fe72800ea83f84cbabd81658dbb33d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;201;-1386.035,364.85;Float;True;Property;_TextureSample2;Texture Sample 2;1;0;Create;True;0;0;False;0;None;35fe72800ea83f84cbabd81658dbb33d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;124;-1442.9,-102.3071;Float;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;False;0;None;35fe72800ea83f84cbabd81658dbb33d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-790.2697,-2724.545;Float;False;Property;_FresnelFalloff;Fresnel Falloff;4;0;Create;True;0;0;False;0;0;0;0;11;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;97;-805.6227,-2830.832;Float;False;Property;_FresnelBalance;Fresnel Balance;3;0;Create;True;0;0;False;0;0;-1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-367.2595,-2880.936;Float;False;Property;_FresnelAmount;Fresnel Amount;5;0;Create;True;0;0;False;0;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;102;51.21591,-993.361;Float;False;Property;_BottomColor;Bottom Color;2;0;Create;True;0;0;False;0;0.1703008,0.8396226,0.1726939,0;0.1703005,0.8396226,0.1726936,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;40;36.71055,-776.9004;Float;False;Property;_TopColor;Top Color;1;0;Create;True;0;0;False;0;0.8949356,0,1,0;0.7496812,0.3973831,0.8867924,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;96;1304.778,174.1463;Float;False;Property;_AOAmount;AO Amount;6;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;147;20.37268,-231.2678;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;72;1551.723,-542.9503;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;99;2065.163,-42.35657;Float;False;Constant;_Float0;Float 0;8;0;Create;True;0;0;False;0;0.25;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;144;-260.1254,-185.3827;Float;False;myVarName;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;136;2313.411,-19.64728;Float;False;113;ShadowDot;1;0;OBJECT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=645E3405A14A9BE112BBBF1D92D5789AD6C5F4F4